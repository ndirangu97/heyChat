...
$messages.=inputController();
        ...
        $info->dataType = "showdeletedmessage";
...
$messages2.=" <div id='messageHolder'>";
$messages2.="<div style='text-align:center;margin:auto;'>No messages from $results->username</div>";
$messages2.="</div>
<hr>";
$messages2.=inputController();
         $info->message = $messages2;
        $info->dataType = "showdeletedmessage";
        echo json_encode($info);
    }
